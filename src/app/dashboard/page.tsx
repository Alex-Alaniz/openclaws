      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        {gatewayReady && (
          <div className="flex items-center justify-between border-b border-emerald-500/10 bg-emerald-500/[0.03] px-4 py-2.5">
            <span className="text-sm text-zinc-300">Your gateway is live and ready.</span>
            <a
                ...
                <div className="w-full max-w-md space-y-4 px-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3 rounded-xl border border-white/10 bg-white/[0.03] p-4">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-zinc-200">Launch Control UI</p>
                        <p className="mt-0.5 text-xs text-zinc-500">Your full AI assistant — browse the web, automate tasks, and more.</p>
