    ...
    <div className="flex h-screen flex-col bg-[#0a0a0a] text-white font-sans">
      <header className="flex h-14 shrink-0 items-center justify-between border-b border-white/[0.1] bg-[#111111]/95 px-4 backdrop-blur">
        <div className="flex items-center gap-1.5">
          <Link
            href="/dashboard"
            className="flex h-5 w-5 items-center justify-center rounded-sm bg-gradient-to-br from-violet-500 to-blue-500 text-[10px] font-bold text-white"
          >
            OC
          </Link>
          <div className="relative hidden sm:block">
            ...
            >
              <span className="text-[8px] text-zinc-500">by</span>
              <span className="translate-y-px text-[8px] text-zinc-500 transition-colors group-hover:text-zinc-300">Composio</span>
            </a>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <Link href="https://discord.gg/composio" target="_blank" className={iconButtonBase} title="Discord">
